...
const EmptyScreen = () => {
    return (
        <View style={[styles.mainContainer, { backgroundColor: colors.darkBackground }]}>
            {/* <Text></Text> */}
            ...
            <Text style={{fontSize: 15, color: colors.lightOrange}}>
                But surely there is something you are {`\n`} wishing for and there is an easy fix.
            </Text>

            <TouchableOpacity onPress={() => (console.log("Press ME"))} style={{marginTop: 50}}>
